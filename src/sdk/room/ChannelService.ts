...
define('',[
    ...
    function ChannelService(this: any, roomService: object) {
    ...
    ChannelService.prototype.getChannelInfo = function getChannelInfo(channelId: string, alias: string, callback: any) {
        if (channelId) {
    ...
    ChannelService.prototype.createChannel = function createChannel(channel:Channel_CreateChannel , callback: any) {
    ...
    ChannelService.prototype.enterChannel = function enterChannel(channelId: string, alias: string, callback: any) {
        if (channelId) {
    ...
    function wrapResponseWithChannelPrefixesAndContinue(callback: (arg0: any, arg1: any) => any, error: string, response: Response_WrapResponse) {
