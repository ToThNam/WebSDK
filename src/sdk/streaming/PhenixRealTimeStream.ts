...
define('',[
    ...
    PhenixRealTimeStream.prototype.streamEndedCallback = function streamEndedCallback(stream: any, status: string, reason: string) {
        _.forEach(this._childrenStreams, function(childStream: { streamEndedCallback: (arg0: string, arg1: string) => void; }) {
    ...
    PhenixRealTimeStream.prototype.streamErrorCallback = function streamErrorCallback(stream: any, errorSource: any, error: any) {
    ...
    PhenixRealTimeStream.prototype.monitor = function monitor(options: { direction: string; }, callback: any) {
